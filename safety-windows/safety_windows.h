...
template<class K>
std::vector<K> find_ratios(std::vector<int> &path, std::vector<std::vector<int>> &dag,
...
template<class K>
std::vector<std::pair<int, int>> safety_windows(std::vector<K> &ratios,
		std::vector<int> &path, K alpha) {
